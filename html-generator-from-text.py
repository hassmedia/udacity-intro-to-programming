'''
This is a program that generates html content from text.
'''
...
# function for finding titles from text
...
# function for finding description from text
def get_description(concept):
    start_location = concept.find('DESCRIPTION:')
    description = concept[start_location+13 :]
    return description

# function for getting all concepts from number
...
# function for assignning concepts to html content
